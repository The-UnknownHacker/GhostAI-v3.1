...
export async function generateTitle(prompt: string) {
	...
	const messages: Array<EndpointMessage> = [
		...
		{ from: "assistant", content: "Who Is President of Gabon" },
		{ from: "user", content: "Who is Julien Chaumond?" },
		{ from: "assistant", content: "Who Is Julien Chaumond" },
		{ from: "user", content: "what is 1 + 1?" },
		{ from: "assistant", content: "Math help" },
		...
		{ from: "assistant", content: "Cheescake Help" },
		{ from: "user", content: "what is your favorite movie? do a short answer." },
		{ from: "assistant", content: "Movie Reccomendation" },
